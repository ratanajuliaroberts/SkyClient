...
### What it does:
SkyClient is a Minecraft mod aiming to provide a interface to install all other necessary SkyBlock mods.
After launching SkyClient you can choose what mods you want to install.
All mods are checked by our teams to ensure, that they comply with Hypixel rules.
